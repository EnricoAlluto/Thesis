//The BachecaManager class manages the bulletin board system, handling room navigation and coordinating 
//with AvatarSelection for avatar interactions. It manages UI elements like buttons and 
//their visual states, processes room transitions, and integrates with RoomCanvasManager 
//for room-specific UI updates. This class serves as a central hub for bulletin board functionality, 
//ensuring smooth transitions between different game states and maintaining UI consistency.
...
public class BachecaManager : MonoBehaviour 
{
    ...
    [Header("References")]
    [Tooltip("Drag the GameObject with RoomCanvasManager component here")]
