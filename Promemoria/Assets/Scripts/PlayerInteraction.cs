//The PlayerInteraction class manages touch-based player interactions in the game. 
//It handles touch inputs, validates them against UI elements, and processes interactions with 
//game objects. The class includes features like touch duration validation, movement threshold checks, 
//and visual debugging with Gizmos. 
//It ensures accurate touch detection while preventing unwanted interactions with UI elements.
...
public class PlayerInteraction : MonoBehaviour 
{
    ...
    //This function visualizes touch interactions in the Unity editor by drawing a red ray from the 
    //camera in the touch direction, helping with debugging touch-based interactions.  
