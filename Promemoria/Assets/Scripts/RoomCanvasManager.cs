//The RoomCanvasManager class manages the visibility and transitions between different UI canvases 
//for room navigation. It handles room selection, back button functionality, 
//and maintains the state of the last visited room. The class coordinates with BachecaManager to
// ensure proper UI flow between room groups (0-2 and 3-5) and provides methods to reset or switch 
//between different canvas states. 
